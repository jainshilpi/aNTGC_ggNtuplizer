...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobs/xSections_QCD_HT100to200_TuneCP5_13TeV-madgraph-pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkim/xSecs/'


config.General.requestName = 'xSections_QCD_HT100to200_TuneCP5_13TeV-madgraph-pythia8'
