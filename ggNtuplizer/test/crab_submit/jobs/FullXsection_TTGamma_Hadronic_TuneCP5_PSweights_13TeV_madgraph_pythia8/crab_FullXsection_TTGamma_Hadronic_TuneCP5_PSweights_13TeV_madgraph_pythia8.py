...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobs/FullXsection_TTGamma_Hadronic_TuneCP5_PSweights_13TeV_madgraph_pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkim/xSecs/'


config.General.requestName = 'FullXsection_TTGamma_Hadronic_TuneCP5_PSweights_13TeV_madgraph_pythia8'
