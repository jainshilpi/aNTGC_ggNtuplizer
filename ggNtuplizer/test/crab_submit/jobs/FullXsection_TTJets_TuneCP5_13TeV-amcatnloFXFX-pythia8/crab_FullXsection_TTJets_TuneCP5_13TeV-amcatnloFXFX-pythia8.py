...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobs/FullXsection_TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkim/xSecs/'


config.General.requestName = 'FullXsection_TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8'
