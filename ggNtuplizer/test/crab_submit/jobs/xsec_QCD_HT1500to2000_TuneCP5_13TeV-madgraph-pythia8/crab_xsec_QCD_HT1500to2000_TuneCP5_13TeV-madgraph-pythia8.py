...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobs/xsec_QCD_HT1500to2000_TuneCP5_13TeV-madgraph-pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkim/xSecs/'


config.General.requestName = 'xsec_QCD_HT1500to2000_TuneCP5_13TeV-madgraph-pythia8'
