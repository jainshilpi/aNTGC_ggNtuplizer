...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsMETv2//beamHalo/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ggNtuplizerMETv2/'


config.General.requestName = 'beamHalo'
...
config.Data.inputDataset = '/beamHalo/mwadud-beamHaloMINIAODSIM_aNTGC-8b3f0a6dce9f2bd2c845840a26003c60/USER'
