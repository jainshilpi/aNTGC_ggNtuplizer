...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsUpdatedAnalyzer//TTGamma_Hadronic_TuneCP5_PSweights_13TeV_madgraph_pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkimV2/'


config.General.requestName = 'TTGamma_Hadronic_TuneCP5_PSweights_13TeV_madgraph_pythia8'
