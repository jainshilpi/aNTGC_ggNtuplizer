...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsUpdatedAnalyzer//TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkimV2/'


config.General.requestName = 'TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8'
