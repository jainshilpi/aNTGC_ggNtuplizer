...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsUpdatedAnalyzer//SinglePhotonRun2017C17Nov2017v1MINIAOD/'

mainOutputDir = '/store/user/mwadud/aNTGC/ggNtuplizerSkimV2/'


config.General.requestName = 'SinglePhotonRun2017C17Nov2017v1MINIAOD'
...
config.Data.inputDataset = '/SinglePhoton/Run2017C-17Nov2017-v1/MINIAOD'
