...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsMETv3//DoubleEGRun2017C31Mar2018v1MINIAOD/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ggNtuplizerMETv3/'


config.General.requestName = 'DoubleEGRun2017C31Mar2018v1MINIAOD'
