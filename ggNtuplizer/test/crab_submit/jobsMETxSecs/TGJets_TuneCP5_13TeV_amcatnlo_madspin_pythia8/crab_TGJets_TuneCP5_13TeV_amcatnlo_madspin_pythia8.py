...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsMETxSecs//TGJets_TuneCP5_13TeV_amcatnlo_madspin_pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/xsecsMET/'


config.General.requestName = 'TGJets_TuneCP5_13TeV_amcatnlo_madspin_pythia8'
