...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsMETxSecs//DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/xsecsMET/'


config.General.requestName = 'DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa'
