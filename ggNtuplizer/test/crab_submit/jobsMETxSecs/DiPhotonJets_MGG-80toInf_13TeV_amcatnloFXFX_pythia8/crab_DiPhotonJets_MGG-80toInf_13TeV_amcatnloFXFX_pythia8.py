...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsMETxSecs//DiPhotonJets_MGG-80toInf_13TeV_amcatnloFXFX_pythia8/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ggNtuplizerMET2016v1/'


config.General.requestName = 'DiPhotonJets_MGG-80toInf_13TeV_amcatnloFXFX_pythia8'
